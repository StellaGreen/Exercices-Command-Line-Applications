...
let index = readlineSync.keyInSelect(choix, chalk.bgBlack.redBright(' Où devez-vous voter ? '))//choisir avec 1, 2, 3, 4 ou 5 d'où l'on vient
const userName = chalk.bgBlack.yellow(readlineSync.question(chalk.yellow('\nPuis-je avoir ton prénom ? ')))//2eme question
    const lastName = chalk.bgBlack.yellowBright(readlineSync.question(chalk.yellowBright('\nPourrais-je avoir ton nom de famille ? ')))//3eme question
